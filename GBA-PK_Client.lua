local IPAddress, Port = "192.168.1.17
local GameID = ""
local GameCode = "None"
local Nickname = ""
	...
	local MultichoiceAdr = 0
		...
		elseif GameID == "BPG2" then
			...
			--Convert 4-byte buffer to readable bytes in case its needed
				TextToNum = 0
				for i = 1, 4 do
					NickNameNum = string.sub(Player1ID,i,i)
	...
	if EnableScript == true then
			...
			if SocketMain:hasdata() then
				...
				if ReadData ~= nil then
					...
					ReceiveDataSmall[34] = string.sub(ReadData,64,64)
					ReceiveDataSmall[34] = tonumber(ReceiveDataSmall[34])
				...
				--	ConsoleForText:print("Type: " .. ReceiveDataSmall[4])
					if ReceiveDataSmall[3] == ReceiveDataSmall[34] and ReceiveDataSmall[4] == "SLNK" then
							...
							if ReceiveDataSmall[5] ~= 0 then
								...
								ReceiveMultiplayerPackets(ReceiveDataSmall[5])
							end
					elseif ReceiveDataSmall[3] == ReceiveDataSmall[34] and ReceiveDataSmall[4] == "POKE" then
							timeout1 = timeoutmax
							local PokeTemp2 = string.sub(ReadData,14,63)
							SetPokemonData(PokeTemp2)
							
					elseif ReceiveDataSmall[3] == ReceiveDataSmall[34] and ReceiveDataSmall[4] == "TRAD" then
					...
					elseif ReceiveDataSmall[3] == ReceiveDataSmall[34] and ReceiveDataSmall[4] == "BATT" then
					...
					elseif ReceiveDataSmall[3] == ReceiveDataSmall[34] then
						timeout1 = timeoutmax
							--Decryption for packet
							ReceiveDataSmall[5] = string.sub(ReadData,14,14)
							ReceiveDataSmall[6] = string.sub(ReadData,15,15)
							ReceiveDataSmall[7] = string.sub(ReadData,16,16)
							ReceiveDataSmall[8] = string.sub(ReadData,17,17)
							ReceiveDataSmall[8] = tonumber(ReceiveDataSmall[8])
							ReceiveDataSmall[9] = string.sub(ReadData,18,19)
							ReceiveDataSmall[10] = string.sub(ReadData,20,21)
							ReceiveDataSmall[11] = string.sub(ReadData,22,22)
							ReceiveDataSmall[11] = tonumber(ReceiveDataSmall[11])
							ReceiveDataSmall[12] = string.sub(ReadData,23,23)
							ReceiveDataSmall[13] = string.sub(ReadData,24,25)
							ReceiveDataSmall[14] = string.sub(ReadData,26,27)
							ReceiveDataSmall[15] = string.sub(ReadData,28,28)
							ReceiveDataSmall[16] = string.sub(ReadData,29,29)
							ReceiveDataSmall[17] = string.sub(ReadData,30,31)
							ReceiveDataSmall[18] = string.sub(ReadData,32,33)
							ReceiveDataSmall[19] = string.sub(ReadData,34,34)
							ReceiveDataSmall[20] = string.sub(ReadData,35,35)
							ReceiveDataSmall[21] = string.sub(ReadData,36,37)
							ReceiveDataSmall[22] = string.sub(ReadData,38,39)
							ReceiveDataSmall[23] = string.sub(ReadData,40,40)
							ReceiveDataSmall[24] = string.sub(ReadData,41,41)
							ReceiveDataSmall[25] = string.sub(ReadData,42,43)
							ReceiveDataSmall[26] = string.sub(ReadData,44,45)
							ReceiveDataSmall[27] = string.sub(ReadData,46, 47)
							ReceiveDataSmall[28] = string.sub(ReadData,48,49)
							ReceiveDataSmall[29] = string.sub(ReadData,50,51)
							ReceiveDataSmall[30] = string.sub(ReadData,52,53)
							ReceiveDataSmall[31] = string.sub(ReadData,54,55)
							ReceiveDataSmall[32] = string.sub(ReadData,56,57)
							ReceiveDataSmall[33] = string.sub(ReadData,58,63)
	...
	--					ConsoleForText:print("Valid package! Contents: " .. ReadData)
			...
			--			ConsoleForText:print("Valid package! Contents: " .. ReadData)
				--	if ReceiveDataSmall[4] == "DTRA" then ConsoleForText:print("Locktype: " .. LockFromScript) end
						...
						if ReceiveDataSmall[4] == "RPOK" then
						...
						--If player 1 requests for a battle
						if ReceiveDataSmall[4] == "RBAT" and ReceiveDataSmall[3] == 1 then
						...
						--If player 1 requests for a trade
						if ReceiveDataSmall[4] == "RTRA" and ReceiveDataSmall[3] == 1 then
							local TooBusyByte = emu:read8(50335644)
							if (TooBusyByte ~= 0 or LockFromScript ~= 0) then
								SendData("TBUS")
							else
						...
						--If player 1 cancels battle
						if ReceiveDataSmall[4] == "CBAT" and ReceiveDataSmall[3] == 1 then
				--			ConsoleForText:print("Other player has canceled battle.")
							OtherPlayerHasCancelled = 1
						end
						--If player 1 cancels trade
						if ReceiveDataSmall[4] == "CTRA" and ReceiveDataSmall[3] == 1 then
				--			ConsoleForText:print("Other player has canceled trade.")
							OtherPlayerHasCancelled = 2
						end
						
						--If player 1 is too busy to battle
						if ReceiveDataSmall[4] == "TBUS" and ReceiveDataSmall[3] == 1 and LockFromScript == 4 then
					--		ConsoleForText:print("Other player is too busy to battle.")
						...
						--If player 1 is too busy to trade
						elseif ReceiveDataSmall[4] == "TBUS" and ReceiveDataSmall[3] == 1 and LockFromScript == 5 then
					--		ConsoleForText:print("Other player is too busy to trade.")
						...
						--If player 1 accepts your battle request
						if ReceiveDataSmall[4] == "SBAT" and ReceiveDataSmall[3] == 1 and LockFromScript == 4 then
							SendData("RPOK")
							if Var8000[2] ~= 0 then
								LockFromScript = 8
								Loadscript(13)
						...
						--If player 1 accepts your trade request
						if ReceiveDataSmall[4] == "STRA" and ReceiveDataSmall[3] == 1 and LockFromScript == 5 then
							SendData("RPOK")
							if Var8000[2] ~= 0 then
								LockFromScript = 9
								Loadscript(14)
						...
						--If player 1 denies your battle request
						if ReceiveDataSmall[4] == "DBAT" and ReceiveDataSmall[3] == 1 and LockFromScript == 4 then
							if Var8000[2] ~= 0 then
								LockFromScript = 7
								Loadscript(11)
							else
						...
						--If player 1 denies your trade request
						if ReceiveDataSmall[4] == "DTRA" and ReceiveDataSmall[3] == 1 and LockFromScript == 5 then
							if Var8000[2] ~= 0 then
								LockFromScript = 7
								Loadscript(7)
							else
						...
						--If player 1 refuses trade offer
						if ReceiveDataSmall[4] == "ROFF" and ReceiveDataSmall[3] == 1 and LockFromScript == 9 then
							OtherPlayerHasCancelled = 3
						end
						
							--If host accepts your join request
						if ReceiveDataSmall[4] == "STRT" then
							Player1AnimationFrame = 0
							Player2AnimationFrame = 0
							Player3AnimationFrame = 0
							Player4AnimationFrame = 0
							if ReceiveDataSmall[3] == 1 then Player1ID = ReceiveDataSmall[2] end
							PlayerID = tonumber(ReceiveDataSmall[5])
							Player1Vis = tonumber(ReceiveDataSmall[12])
							Player2Vis = tonumber(ReceiveDataSmall[16])
							Player3Vis = tonumber(ReceiveDataSmall[20])
							Player4Vis = tonumber(ReceiveDataSmall[24])
							if PlayerID ~= 1 then
								NewMapX = tonumber(ReceiveDataSmall[9])
								NewMapY = tonumber(ReceiveDataSmall[10])
						--		Facing = tonumber(ReceiveDataSmall[11])
								--Action type -> can be walk or run
								PlayerExtra1 = tonumber(ReceiveDataSmall[25])
								PlayerExtra2 = tonumber(ReceiveDataSmall[26])
								FixPositionPlayer1()
								MapX = NewMapX
								MapY = NewMapY
							end
							if PlayerID ~= 2 then
								NewMapX2 = tonumber(ReceiveDataSmall[13])
								NewMapY2 = tonumber(ReceiveDataSmall[14])
						--		Facing2 = tonumber(ReceiveDataSmall[15])
								Player2Extra1 = tonumber(ReceiveDataSmall[27])
								Player2Extra2 = tonumber(ReceiveDataSmall[28])
								FixPositionPlayer2()
								MapX2 = NewMapX2
								MapY2 = NewMapY2
							end
						...
						if ReceiveDataSmall[4] == "SPOS" then
							Player1Vis = tonumber(ReceiveDataSmall[12])
							Player2Vis = tonumber(ReceiveDataSmall[16])
							Player3Vis = tonumber(ReceiveDataSmall[20])
							Player4Vis = tonumber(ReceiveDataSmall[24])
							...
							if ReceiveDataSmall[3] == 1 then
								Player1ID = ReceiveDataSmall[2]
								ReceiveDataSmall[33] = tonumber(ReceiveDataSmall[33])
								if MapID ~= ReceiveDataSmall[33] then
									NewMap = 1
									NewMapConnectPrev = MapID
									MapStartX = tonumber(ReceiveDataSmall[9])
									MapStartY = tonumber(ReceiveDataSmall[10])
									if MapStartX > 9 then MapStartX = MapStartX - 10 end
									if MapStartY > 9 then MapStartY = MapStartY - 10 end
									MapID = ReceiveDataSmall[33]
								end
								if MapID == PlayerMapID then
									MapXPrev = tonumber(ReceiveDataSmall[9])
									MapYPrev = tonumber(ReceiveDataSmall[10])
								...
								PlayerExtra2 = tonumber(ReceiveDataSmall[26])
								FixPositionPlayer1()
								NewMapConnect = tonumber(ReceiveDataSmall[8])
							elseif ReceiveDataSmall[3] == 2 then
								ReceiveDataSmall[33] = tonumber(ReceiveDataSmall[33])
								if MapID2 ~= ReceiveDataSmall[33] then
									NewMap2 = 1
									NewMapConnect2Prev = MapID2
									MapStartX2 = tonumber(ReceiveDataSmall[13])
									MapStartY2 = tonumber(ReceiveDataSmall[14])
									if MapStartX2 > 9 then MapStartX2 = MapStartX2 - 10 end
									if MapStartY2 > 9 then MapStartY2 = MapStartY2 - 10 end
									MapID2 = ReceiveDataSmall[33]
								end
								if MapID2 == PlayerMapID then
									MapX2Prev = tonumber(ReceiveDataSmall[13])
									MapY2Prev = tonumber(ReceiveDataSmall[14])
								...
								Player2Extra2 = tonumber(ReceiveDataSmall[28])
								FixPositionPlayer2()
								NewMapConnect2 = tonumber(ReceiveDataSmall[8])
							elseif ReceiveDataSmall[3] == 3 then
								
							elseif ReceiveDataSmall[3] == 4 then
...
function CreatePackett(RequestTemp, PackettTemp)
	...
	Packett = GameID .. Nickname .. PlayerID .. RequestTemp .. PackettTemp .. MapX .. MapY .. Facing .. MapX2 .. MapY2 .. Facing2 .. MapX3 .. MapY3 .. Facing3 .. MapX4 .. MapY4 .. Facing4 .. PlayerExtra1 .. PlayerExtra2 .. Player2Extra1 .. Player2Extra2 .. Player3Extra1 .. Player3Extra2 .. Player4Extra1 .. Player4Extra2 .. PlayerMapID .. PrevMapTemp .. NewMapConnect .. PlayerID
--	ConsoleForText:print("Packett: " .. Packett)
	FixAllPositions()
end
...
function ConnectNetwork()
	...
	--	ConsoleForText:print("Connection Type: " .. ReturnConnectionType)
		if ReturnConnectionType == "STRT" then
			console:log("You have connected to " .. Player1ID)
			ConsoleForText:moveCursor(0,3)
			ConsoleForText:print("You have successfully connected.                                                          ")
			ConsoleForText:moveCursor(0,15)
			ConsoleForText:print("Connected to a server: Yes                 ")
	...
	if EnableScript == true and initialized ~= 0 then
		...
		--		ConsoleForText:print("Pressed A")
				...
				--		if TempVar2 == 0 then ConsoleForText:print("MapX: " .. MapX .. " MapY: " .. MapY) end
					...
					--		ConsoleForText:print("Player1 Any direction")
							emu:write16(Var8000Adr[1], 0) 
							emu:write16(Var8000Adr[2], 0) 
							emu:write16(Var8000Adr[14], 0)
